...
OPTION( blockminclslim,    4,  2,2e9,0,0,1, "minimum clause size") \
...
OPTION( conditionreleff, 100,  1,1e5,0,0,1, "relative efficiency in per mille") \
...
OPTION( elimocclim,      1e3,  0,2e9,2,0,1, "occurrence limit") \
OPTION( elimprod,          1,  0,1e4,0,0,1, "elimination score product weight") \
...
OPTION( simplify,          1,  0,  1,0,0,0, "enable simplifier") \
...
OPTION( stabilizephase,    1,  0,  1,0,0,0, "use target variable phase") \
OPTION( subsume,           1,  0,  1,0,1,1, "enable clause subsumption") \
OPTION( subsumebinlim,   1e4,  0,2e9,1,0,1, "watch list length limit") \
OPTION( subsumeclslim,   1e3,  0,2e9,2,0,1, "clause length limit") \
...
OPTION( vivifyredeff,    300,  0,1e3,1,0,1, "redundant efficiency per mille") \
OPTION( vivifyreleff,     80,  1,1e5,1,0,1, "relative efficiency per mille") \
